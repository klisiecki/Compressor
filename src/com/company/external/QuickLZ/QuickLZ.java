package com.company.external.QuickLZ;
...
public final class QuickLZ
{
    ...
    public static void main(String[] args) throws IOException {
        ...
        File decompressedFile = new File("QuickLZ_decompress.txt");
        FileOutputStream fs2 = new FileOutputStream(decompressedFile);
        ObjectOutputStream oos2 = new ObjectOutputStream(fs2);
        oos2.write(decompressed);
        oos2.close();
        fs2.close();
    }
